...
*
	...
	chain-set: 123409                                                             // total chained parts
	chain-get: 4563                                                               // chain parts
*
"""
...
metadata_send = [] # [to send] [[batch_id, start, end, fixed len, len],]
...
class SPLITTING:
	...
	def regtr(self, chopped_data=""):
		...
		# push chunk_metadata to metadata_send
		metadata_send.append(chunk_metadata)
...
if __name__ == "__main__":
	...
	STITCHING().build(metadata=metadata_send)
	print(time.time() - uh)
